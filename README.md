...
- Run explicit batch calibration over a selected time range.
- Review correction bins, quality metrics, warnings, and a correction plot.
...
- Signal K context.
- metric names for heading, COG, SOG, variation, and rate of turn.
- source selections.
- calibration filters.
