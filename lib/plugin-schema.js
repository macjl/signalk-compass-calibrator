      ...
      filters: {
        ...
        properties: {
          ...
          maxSampleSkewSeconds: {
            ...
            description: 'Maximum timestamp difference in seconds allowed between HDG, COG, SOG, and variation samples.',
            default: DEFAULT_OPTIONS.filters.maxSampleSkewSeconds
          },
          maxSampleAgeSeconds: {
            type: 'number',
            title: 'Maximum sample age',
            description: 'Maximum age in seconds allowed for each input sample.',
